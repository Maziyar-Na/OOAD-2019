...
def persistRecord(conn,dta, id):
    ...
    #insertString = "Insert into book  (ID, Author, ISBN10, ISBN13, Title, PubDate, PageCount, Lang,Format, SubTitle, url,Publisher,Subject, SubSubject) VALUES({:d}, '{}', '{}'," \
    #               "'{}', '{}','{}', {:d}, '{}', '{}','{}' ,'{}', '{}' ,'{}' , '{}')".format(id, author, isbn_10, isbn_13, title, pubdate,pageCount,language,format, subtitle,url, publisher,sub,sub2)


    insertString = "insert into book (ID, book_name, author, isbn_num, type, available) values ({:d}, '{}', '{}', '{}', 1, 1)".format(id, title[:100], author[:100],isbn_10[:10])
